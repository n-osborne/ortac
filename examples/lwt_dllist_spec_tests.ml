  ...
  struct
      ...
      let open QCheck in
        let open Gen in
          oneof_weighted
            ...
            (1, (pure Take_opt_l));
            (1, (pure Take_opt_r))]
    let gen_cmd state__094_ =
      let open QCheck.Gen in (with_flag Seq) <$> (gen_cmd state__094_)
    ...
    let next_state cmd__006_ state__007_ =
      ...
      | Create () ->
          ...
          then Model.push (Model.drop_n state__007_ 0) s__009_
...
let ortac_show_cmd cmd__090_ models__091_ last__093_ res__092_ =
  let open Spec in
    let open STM in
      match ((cmd__090_.raw_cmd), res__092_) with
      | (Create (), Res ((SUT, _), s)) ->
...
let ortac_postcond cmd__029_ state__030_ res__031_ =
  let open Spec in
    let open STM in
      ...
      match ((cmd__029_.raw_cmd), res__031_) with
